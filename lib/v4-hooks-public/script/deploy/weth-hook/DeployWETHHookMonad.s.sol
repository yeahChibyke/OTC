...
/// @notice Mines the address and deploys the WETHHook.sol Hook contract on Monad
contract DeployWETHHookMonadScript is Script {
    address constant CREATE2_DEPLOYER = address(0x4e59b44847b379578588920cA78FbF26c0B4956C);

    IPoolManager constant POOLMANAGER = IPoolManager(address(0x188d586Ddcf52439676Ca21A244753fA19F9Ea8e));
    address payable public constant WETH_ADDRESS = payable(0x3bd359C1119dA7Da1D913D1C4D2B7c461115433A);
