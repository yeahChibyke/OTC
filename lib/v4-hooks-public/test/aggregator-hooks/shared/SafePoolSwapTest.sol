...
import {SafeCurrencySettler} from "./SafeCurrencySettler.sol";

/// @title SafePoolSwapTest
/// @notice A version of PoolSwapTest that uses SafeERC20 for token transfers.
/// @dev This properly handles non-standard ERC20 tokens like USDT that don't return a boolean.
contract SafePoolSwapTest is IUnlockCallback {
    using SafeCurrencySettler for Currency;
